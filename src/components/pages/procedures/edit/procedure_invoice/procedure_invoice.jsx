...
const ProcedureInvoice = (props) => {
  ...
  const proceduringTemplateId             = data && data.procedure.proceduringTemplate.id
  ...
  const BREADCRUMBS =  [
    ...
    { name: "Editar", path: `/procedures/${ match.params.id}/edit` },
  ...
  return(
    ...
    <Paper>
      <Grid container>
          ...
          <Grid container item direction="row">
            <TabSeccion
              proceduringTemplateId={proceduringTemplateId}
              procedure={procedure}
            />
          </Grid>
          <Grid container item direction="row">
...
export default withStyles(styles)(ProcedureInvoice);
