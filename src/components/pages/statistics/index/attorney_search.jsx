...
const AttorneySearch = (props) => {
  const { attorneyId, setAttorneyId } = props;
  ...
  useEffect(() => {
    if(attorneyInfo && (attorneyInfo.id !== attorneyId)) {
      setAttorneyId(attorneyInfo.id)
    }
  })
    ...
    return(
      ...
      { !!attorneyInfo ?
        <FormControl variant="outlined" fullWidth>
          <InputLabel htmlFor={attorneyInfo.id}>Abogado</InputLabel>
          <Input
            value={`${attorneyInfo.firstName} ${attorneyInfo.lastName}`}
            disabled
            size="small"
            variant="outlined"
            fullWidth
            endAdornment={
              <InputAdornment position="end">
                <IconButton onClick={cancelClientSelect} edge="end">
      ...
      <TableBody>
        {
          data && data.clients.map((client, index ) => {
            ...
            <TableRow
              ...
              key={client.id}
              hover 
              selected={attorneyInfo ? client.id === attorneyInfo.id : client.id === selectedIndex} 
