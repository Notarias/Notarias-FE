...
const BudgetCommentaries = (props) => {
  ...
  const { loading, data } = useQuery(
    GET_BUDGET, { variables: {"id": commentableId } }
  );

  useEffect(() => {
    if(data && data.budget.budgetingTemplate) {
      setBudget(data.budget.budgetingTemplate)
    }
  }, [loading]);
...
export default BudgetCommentaries;
